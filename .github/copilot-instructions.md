...
**Single script**: `src/Collect-ApertureData.ps1` (~3,300 lines). Build system (`build.ps1`) embeds KQL queries into `dist/Collect-ApertureData.ps1` for self-contained distribution. Source runs directly when `queries/` folder is present.
